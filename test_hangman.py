...
class test_hangman(unittest.TestCase):
    ...
    def test_get_available_letters(self):
        ...
        self.assertEqual(get_available_letters(APLE),
                         "".join(NO_APLE))      
        self.assertEqual(get_available_letters(AELP),
                         "".join(NO_APLE))
    ...
    def test_get_score(self):
        # Test score with 'apple' 4 letters and 6 guesses 4*6 = 24
        self.assertEqual(get_score('apple', (3, 6)), 24)
        
        # Test score with 'mississippi' 4 letters and 1 guesses 4*1 = 4
        self.assertEqual(get_score('mississippi', (-1, 1)), 4)
        
        # Test score with 'apple' 4 letters and 3 guesses 4*3 = 12
        self.assertEqual(get_score('apple', (0,3)), 12)
