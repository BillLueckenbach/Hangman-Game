...
def get_score(secret_word, warnings_and_guesses_left):
    '''
    get_score calculates the winning score of the game by multiplying the 
        number of guesses left times the number of unique letters in 
        secret_word.
    ...
    '''
    # Use a Counter container to determine the number of uinque letters in
        #secret_word
    from collections import Counter
    
    secret_word_Counter = Counter(secret_word)
    
    return len(secret_word_Counter) * warnings_and_guesses_left[1]
    ...
    * After each guess, you should display to the user the 
    ...
    if won_game:
        ...
        print("Your total score for this game is:",
              get_score(secret_word,a warnings_and_guesses_left)
             )
    else:
